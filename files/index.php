...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIME TABLE MANAGEMENT SYSTEM, Spèciality  Rèseaux, Univ_ouargla</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/aa.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/bb.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/labo.jpg" alt="Flower">
        </div>
...
<div align="center" STYLE="margin-top: 30px">
    ...
    <button data-scroll-reveal="enter from the bottom after 0.2s"
            id="ètudiantLoginBtn" class="btn btn-info btn-lg">ètudiant LOGIN
    </button>
</div>
<br>
...
<script>
    ...
    ètudiantLoginBtn.onclick = function () {
        modal.style.display = "block";
        heading.innerHTML = "Faculty Login";
        facultyForm.style.display = "block";
        adminForm.style.display = "none";
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4>Algeria_ouargla</h4>
                <h4><strong>Call:</strong>+213654365423 </h4>
                <h4><strong>Email: </strong>info@gmail.com</h4>
            </div>
